...
const Nav = () => {
  ...
  return (
    <>
      <AppBar
        className={`fixed backdrop-blur-sm bg-white/75 dark:bg-slate-900/100 h-10 z-10 px-4 w-full border-b border-slate-500 text-slate-900 dark:text-slate-50 ${ open ? 'ml-0' : ''}`}
        position="static"
      >
